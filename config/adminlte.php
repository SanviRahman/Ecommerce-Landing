    ...
    */
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text'    => 'Add Order Field',
                    'url'     => '#',
                    'icon'    => 'fas fa-fw fa-plus',
                    'can'     => 'admin',
                    'classes' => 'js-add-order-field text-success',
                    'active'  => [],
                ],
                [
                    'text'   => 'Delete Order Field',
                    'url'    => 'admin/orders/order-fields',
                    'icon'   => 'fas fa-fw fa-trash',
                    'can'    => 'admin',
                    'active' => ['admin/orders/order-fields*'],
                ],
                [
                    'text'   => 'Fake Orders',
