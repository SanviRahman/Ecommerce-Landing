...
class CampaignSeeder extends Seeder
{
    public function run(): void
    {
        ...
        */
        ...
        $this->command?->info('Campaign seeded successfully with categories, brands, products and hero contact numbers. Configure delivery areas from the campaign form.');
    }
