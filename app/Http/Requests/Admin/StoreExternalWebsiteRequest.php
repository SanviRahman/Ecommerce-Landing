...
class StoreExternalWebsiteRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'token_action' => trim((string) $this->input('token_action')),
            'api_token' => trim((string) $this->input('api_token')),
            'remote_api_token' => trim((string) $this->input('remote_api_token')),
        ]);
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'api_token' => [
                Rule::requiredIf(fn (): bool => $this->input('token_action') === 'manual'),
                'nullable',
                'string',
                'min:32',
                'max:2000',
    ...
    public function messages(): array
    {
        return [
            ...
            'token_action.required' => 'Please select how the receiver token will be configured.',
            'api_token.required' => 'Enter the receiver token generated by this or the external website.',
