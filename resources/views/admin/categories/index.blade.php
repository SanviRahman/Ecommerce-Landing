    ...
    <div class="card-header bg-white py-3 border-0">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 mt-2 mt-md-0 text-md-right">
                ...
                <button class="btn btn-primary btn-sm px-4 shadow-sm ml-2" id="btnAddCategory"
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btnDelete, .btnRestore, .btnForceDelete', function() {
        ...
        Swal.fire({
            ...
            type: isRestore ? 'question' : 'warning', // SweetAlert2 v8 compatibility
            ...
            if (result.isConfirmed || result.value) {
                $.ajax({
                    url: url,
                    // Set HTTP method dynamically: DELETE for deletion, POST for restoration
