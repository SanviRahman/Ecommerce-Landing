...
<div class="d-flex justify-content-between align-items-center">
    ...
    <div>
        ...
        <a href="{{ route('admin.campaigns.edit', $campaign->id) }}" class="btn btn-info rounded-pill px-4">
            <i class="fas fa-edit mr-1"></i> Edit
        </a>

        <a href="{{ route('admin.campaigns.index') }}" class="btn btn-secondary rounded-pill px-4">
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <img src="{{ $campaign->banner_image_url }}" alt="Banner Image" class="img-fluid img-thumbnail">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <img src="{{ $campaign->image_one_url }}" alt="Image One" class="img-fluid img-thumbnail">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <img src="{{ $campaign->image_two_url }}" alt="Image Two" class="img-fluid img-thumbnail">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <img src="{{ $campaign->image_three_url }}" alt="Image Three" class="img-fluid img-thumbnail">
                    </div>
                </div>
                ...
                <div class="mb-0">
                    ...
                    <div>
                        <img src="{{ $campaign->review_image_url }}" alt="Review Image" class="img-fluid img-thumbnail">
                    </div>
                </div>
                ...
                <div class="mb-0">
                    ...
                    <div class="row">
                        @forelse($campaign->getMedia('campaign_product_gallery') as $media)
                        <div class="col-6 mb-2">
                            <a href="{{ $media->getUrl() }}" target="_blank">
                                <img src="{{ $media->getUrl() }}" alt="Product Gallery" class="img-fluid img-thumbnail"
                                    style="height: 110px; width: 100%; object-fit: cover;">
                            </a>
                        </div>
                        @empty
                        <div class="col-12">
                            <span class="text-muted">No product gallery images added.</span>
                        </div>
                        @endforelse
                    </div>
                </div>
