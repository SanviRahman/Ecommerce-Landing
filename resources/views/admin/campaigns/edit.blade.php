...
@section('content_header')
    <div class="page-title-box d-flex justify-content-between align-items-center">
        <div>
            ...
            <small class="text-muted">Update campaign landing page information.</small>
        </div>
...
@section('content')
    <div class="card campaign-card">
        <div class="card-header">
            ...
            <p>
                Selected products will be shown inside the product field. Click the field to add more products.
            </p>
        </div>
